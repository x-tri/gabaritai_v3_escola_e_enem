...
# AJUSTADO: valores mais baixos para capturar marcações fracas e fora do círculo
MARKED_THRESHOLD = 22.0      # % escuro absoluto para considerar marcado
BLANK_THRESHOLD = 16.0       # Se a mais escura < 16%, questão em branco
...
DARK_PIXEL_THRESHOLD = 185   # Valor de pixel para considerar escuro (inclui cinzas mais claros)
